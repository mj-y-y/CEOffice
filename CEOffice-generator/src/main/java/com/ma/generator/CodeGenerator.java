...
// 全局配置
        ...
        gc.setOutputDir(projectPath + "/CEOffice-generator/src/main/java");
//作者
...
// 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/CEOffice-generator/src/main/resources/mapper/"
